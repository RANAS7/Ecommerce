  ...
  return (
    <div className="bg-white">
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-2 -mt-8">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="lg:col-span-3">
                <ProductGrid products={filteredProdutcFunc()}></ProductGrid>
              </div>
              {/* Product grid end */}
            </div>
          </section>
...
function DesktopFilter({ handleFilter, filters }) {
  ...
  const toggleOption = (sectionId, option) => {
    setActiveOptions((prevState) => {
      ...
      const isActive = newState[sectionId]?.[option.value];

      // If active, deactivate it; otherwise, activate it
      newState[sectionId] = {
        ...newState[sectionId],
            ...
            <>
              <h3 className="-my-3 flow-root">
                <Disclosure.Button className="flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                  ...
                  <span className="ml-6 flex items-center">
                    {open ? (
                      <MinusIcon
                        className="bg-gray-700 text-white rounded-xl h-5 w-5"
                        aria-hidden="true"
                      />
                    ) : (
                      <PlusIcon
                        className="h-5 w-5 bg-gray-700 text-white rounded-xl"
                        aria-hidden="true"
                      />
                    )}
                  </span>
              ...
              <Disclosure.Panel className="pt-6">
                <div className="space-y-4">
                  {/* Render options as capsule-like buttons */}
                          ...
                          handleFilter(
                            {
                              target: {
                                checked:
                                  !activeOptions[section.id]?.[option.value],
                              },
                            },
                            section,
                            option
                          );
                          toggleOption(section.id, option);
                        }}
